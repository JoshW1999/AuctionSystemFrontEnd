...
class Session {
    public:
        ...
        /*
            ...
            Output: None
        */
        Session(std::string userAccount, std::string availableItems);
        ...
        */
        ...
        /*
            ...
            Input: The string of the wanted username
            Output: Returns an object of type User
        */
        User getUser(std::string username);
        
        /*
            Purpose: Get the item object with the passed username
            Input: The string of the wanted item name
            Output: Returns an object of type User
        */
