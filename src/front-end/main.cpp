        ...
        if (!session.getIsLogin()) { 
            ...
            if (command == "create") {
                ...
                if (u->userType == "SS")
                    ...
                    if(session.getItem(itemName).getSeller()==u->getUsername()){
                        cout << "\n[ERROR] Can't bid on your own item " << endl;
                        continue;
                    }
                    ...
                    if(u->userType == "AA"){
                        if (price < highestBid){
                            cout << "\n[ERROR] New bid needs to be higher than previous bid \n";
                            continue;
                        }
                    }
                    ...
                    if (price > 999.99){
                        cout << "\n[ERROR] Item price limit reached \n";
                        continue;
                    }
                    ...
                    if((u->userType != "AA") && price < (1.05*highestBid)){
                        cout << "\n[ERROR] New bid needs to be 5% higher than previous bid \n";
                        continue;
                    }
